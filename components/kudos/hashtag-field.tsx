...
import { HashtagPicker } from "@/components/kudos/hashtag-picker";
...
/**
 * "Hashtag" field: removable chips for the current selection + a
 * "+ Hashtag" trigger that opens Phase 3's `<HashtagPicker>` in a popover.
 * Does not fetch the hashtag list itself — the parent (`kudos-modal.tsx`)
 * fetches it once via `listHashtags()` and passes it down here.
 */
