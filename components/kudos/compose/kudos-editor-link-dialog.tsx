  ...
  return createPortal(
    ...
    >
      <div className="flex min-h-full">
        {/* fix-bug: shrunk to match the compose/edit modal shell scale. */}
        <div className="m-auto flex w-[560px] max-w-full flex-col gap-4 rounded-3xl bg-details-modal-background p-7">
          <h2 className="font-montserrat text-[26px] font-bold text-details-text-primary-2">{t("title")}</h2>
          <div className="flex flex-col gap-2">
            <div className="flex items-center gap-4">
              ...
              <input
                ...
                className={`h-12 flex-1 rounded-lg border bg-details-text-secondary-1 px-5 font-montserrat text-sm font-bold text-details-text-primary-2 placeholder:text-details-text-secondary-2 focus:outline-none ${
          ...
          <div className="flex justify-start gap-4">
            ...
            <button
              type="button"
              onClick={handleSave}
              className="flex flex-1 items-center justify-center gap-2 rounded-lg bg-details-text-primary-1 px-4 py-3 font-montserrat text-lg font-bold text-details-text-primary-2"
            >
              {t("save")}
              <LinkIcon />
            </button>
