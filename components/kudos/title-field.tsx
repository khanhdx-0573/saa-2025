    ...
    <div className="flex flex-col gap-2">
      <div className="flex flex-1 items-center gap-4">
        <label
          ...
          className="w-[146px] shrink-0 whitespace-nowrap font-montserrat text-[22px] font-bold text-details-text-primary-2"
        >
          {t("titleLabel")}{" "}
      ...
      <div className="flex items-start gap-4">
        <span className="w-[146px] shrink-0" aria-hidden="true" />
        <p className="whitespace-pre-line font-montserrat text-base font-bold text-details-text-secondary-2">
          {t("titleHelper")}
        </p>
      </div>
    </div>
