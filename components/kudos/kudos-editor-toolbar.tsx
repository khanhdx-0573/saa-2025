...
export function KudosEditorToolbar({ editor, onOpenLink }: KudosEditorToolbarProps) {
  ...
  return (
    <div className="flex flex-wrap items-center divide-x divide-details-border rounded-t-lg border border-b-0 border-details-border">
      ...
      <span className="flex h-10 items-center whitespace-nowrap px-3 font-montserrat text-sm font-bold text-details-community-link underline">
...
function ToolbarButton({
  ...
  return (
    <button
      ...
      title={label}
      onClick={onClick}
      className={`flex h-10 items-center justify-center px-3 font-montserrat text-sm text-details-text-primary-2 ${
