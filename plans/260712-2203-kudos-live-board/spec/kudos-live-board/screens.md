...
| Screen | Type | Purpose |
|--------|------|---------|
| Live Board (`/kudos`) | Composite page | Full recognition feed: banner, compose entry, Highlight carousel, Spotlight board, All Kudos feed, sidebar. Design item groups A / A.1 / B / B.1 / B.6–B.7 / C / D. |
...
2. Banner (A) and compose entry pill (A.1) render at top; clicking the pill opens the existing F001 "Viết Kudo" modal.
