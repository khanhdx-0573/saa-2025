...
bar (A.1) reuses the existing F001 "Viết Kudo" modal unchanged. A separate Sunner search box sits next to it,
letting a viewer look a colleague up by name and jump straight to their profile.
